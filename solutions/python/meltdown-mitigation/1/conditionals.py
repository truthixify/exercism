...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    """
    tn = temperature * neutrons_emitted
    if temperature < 800 and neutrons_emitted > 500 and tn < 500000:
        return True
    else:
        return False
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    percentage_increase_or_decrease = ((temperature * neutrons_produced_per_second - threshold) * 100) / threshold

    if percentage < 90:
        return 'LOW'
    elif abs(percentage_increase_or_decrease) <= 10:
        return 'NORMAL'
    else:
        return 'DANGER'
